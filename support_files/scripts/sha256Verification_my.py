...
def XunsSha256(binary512bits):
	...
	for i in range(16,64): 
		...
		W64.append(w)
		print("{0}, i-2: {1}, i-7: {2}, i-15: {3}, i-16: {4}".format(i,"0x{0:08x}".format(W64[i-2]),"0x{0:08x}".format(W64[i-7]),"0x{0:08x}".format(W64[i-15]),"0x{0:08x}".format(W64[i-16])))
		print("Block {0} is {1}".format(i,"0x{0:08x}".format(W64[i])))
